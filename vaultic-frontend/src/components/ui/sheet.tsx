...
/**
 * Sheet — slide-in drawer panel (Task 28).
 *
 * Built on top of `@radix-ui/react-dialog` so we reuse the same focus-trap,
 * escape-to-close, and portal behaviour as the existing Dialog
 * component. A Sheet is a Dialog whose content animates in from the edge
 * of the viewport instead of centring on top of the overlay.
 *
 * Variants: `left`, `right`, `top`, `bottom`. The mobile hamburger nav
 * uses `left`, matching conventional drawer placement.
 */
